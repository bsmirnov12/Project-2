...
## Table semantics and datatypes are in the DDL code:
...
## Order of operations when adding new chart line:

1. Add song name and performer to the Song table, obtain song_id
2. Split performer into a list of 1 or more artists (for collaborations), save them in Artist table, obtain a list of corresponding artist_ids
3. Add artist_ids into the Performed_by table for this song_id specifying their order of appearance
4. Add song_id to the chart for the corresponding (year, week, position)
